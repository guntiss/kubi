  ...
  function reconcileTable(table, rows, columns) {
    ...
    rows.forEach((row, index) => {
      ...
      if (found) {
        ...
        // to go: leaving it in the map would have dropped it from the sweep
        // below, and it would sit in the table as a duplicate of this row.
        if (!reused) {
    ...
    // Whatever the refresh no longer reports: objects deleted from the cluster,
    // or filtered out by a narrowed search.
